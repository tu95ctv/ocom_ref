...
class PartnerXlsx(models.AbstractModel):
    ...
    def generate_xlsx_report(self, workbook, data, partners):
        for obj in partners:
            ...
            self.get_xlsx(options, response=None,workbook=workbook, headers=headers, lines = lines)
    ...
    def get_xlsx(self, options, response=None,workbook=None, headers=None, lines = None):
